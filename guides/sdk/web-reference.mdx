...
Initialize the SDK before mounting any checkout component.
...
|-----------|------|----------|-------------|
| `publicApiKey` | `string` | Yes | Your Yuno public API key from Dashboard > API Keys |
...
<Warning>
Never include your private secret key in client-side code. Use only the public API key.
</Warning>
...
| `PaymentResult` | Payment outcome object with status, paymentId, and error |
